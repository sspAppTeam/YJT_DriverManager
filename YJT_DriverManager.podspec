...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of YJT_DriverManager.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/SSPSource/YJT_DriverManager'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'SSPSource' => '2316585240@qq.com' }
  s.source           = { :git => 'https://github.com/SSPSource/YJT_DriverManager.git', :tag => s.version.to_s }
